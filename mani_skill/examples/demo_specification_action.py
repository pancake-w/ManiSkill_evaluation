...
def main(args: Args):
    ...
    """ Youd should modify below. """
    pos = np.array([ 0.43 , -0.239,  0.676])
    quat = np.array([-3.049, -0.174,  0.967,  0.851])
    """ Youd should modify above. """

    while True:
        action = np.concatenate([pos, quat],axis=0)
